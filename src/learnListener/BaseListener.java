...
import learnListener.ErrorUtil;
...
public class BaseListener extends TestListenerAdapter implements IInvokedMethodListener{


	public void onTestFailure (ITestResult tr){
		System.out.println ("Listener: Failed  === " + tr.getName());
	}
	...
	public void onTestSuccess (ITestResult tr){
		System.out.println ("Listener: Test Passed  === " + tr.getName());
	}
